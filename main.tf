...
module "swap" {
  source = "./provisioning/service/swap"
...
module "wireguard" {
  source = "./provisioning/security/wireguard"
...
module "firewall" {
  source = "./provisioning/security/ufw"
...
module "etcd" {
  source = "./provisioning/service/etcd"
...
module "kubernetes" {
  source = "./provisioning/service/kubernetes"
